...
function processSum(numberList, callback) {
  return callback(numberList.reduce((accumulator, currentNum) => { return accumulator + currentNum; }, 0))
}
...
function tallyUpDonations(runners) {
  return runners.reduce( (sumTotal, runner ) => { return sumTotal + runner.donation }, 0 )
}
